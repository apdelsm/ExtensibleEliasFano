/*
THIS FILE WAS CHANGED BY ABDEL SANDOVAL
*/
...
class btree_container {
 ...
 public:
  ...
  void * getPredecessor(const key_type &key, uint32_t bufferSize) {
  ...
  size_type eefsize() const { return tree_.bytes_used(); }
...
class btree_unique_container : public btree_container<Tree> {
 ...
 public:
  ...
  std::pair<iterator,bool> push(std::tuple<uint32_t, uint32_t, sdsl::sd_vector<>>*x, uint32_t bufferSize) {
